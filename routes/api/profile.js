...
// @route     GET api/profile/user/:user__id
...
router.delete('/', auth, async (req, res) => {
  try {
    ...
    // Remove Profile of user from profile collection
...
// @desc    delete an experience of a user
// @access  Private
...
// @desc    delete education of a user
// @access  Private
